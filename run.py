...
def run_day(
    ...
    day_package_path = Path(__file__).parent / day_package_name
    if not day_package_path.exists():
        raise ValueError(f"Solution dir not found for day = {day_package_path}")

    input_path = day_package_path / input_file
