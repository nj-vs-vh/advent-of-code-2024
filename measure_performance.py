...
if __name__ == "__main__":
        ...
        try:
            ...
            for _ in range(30):
                with suppress_output():
                    t1, t2 = run_day(day, input_file="input.txt", parts_to_run=[1, 2], debug=False)
                if t1 is None:
    ...
    for (day, (part_1, part_2)), both_parts, score in zip(
        ...
        total_both_parts = both_parts if total_both_parts is None else total_both_parts + both_parts
